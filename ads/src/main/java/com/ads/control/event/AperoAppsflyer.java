 ...
 */
public class AperoAppsflyer extends Integration<AppsFlyerLib> {
    ...
    public static void setManualMode(Boolean manualMode) {
        AperoAppsflyer.manualMode = manualMode;
    }
    ...
    public static final Factory FACTORY = new Integration.Factory() {
        ...
        public Integration<AppsFlyerLib> create(ValueMap settings, Analytics analytics) {
            ...
            return new AperoAppsflyer(application, logger, afLib, devKey);
        }
    ...
    public AperoAppsflyer(Context context, Logger logger, AppsFlyerLib afLib, String devKey) {
